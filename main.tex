...
\indent The point cloud from LiDAR preprocesses before the fusion between the camera image and the LiDAR point cloud.
...
And we will match between the bounding IOU and the object label on the images by Hungarian method.
