...
\begin{figure}[H]
    \begin{center}
        \scalebox{0.8}{
            \includegraphics{figure/proposed_sw_system.png}
        }
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \scalebox{0.4}{
        \includegraphics{figure/arch_nav.png}
        }
    \end{center}
...
navi\_sim utilizes Embree, an open-source ray tracing library developed by Intel, to simulate lidar with fast CPU ray tracing.
